...
|-----|:-----:|:------------:|--------:|
|1.b |BUSCO||This creates short_summary.txt. >>> Tip: Run generate_plot to create a graph of the sumamry. <<<|
...
|2.c|BUSCO||This creates short_summary.txt. >>> Tip: Run generate_plot to create a graph of the sumamry. <<<|
...
|3.d|BUSCO||This creates short_summary.txt. >>> Tip: Run generate_plot to create a graph of the sumamry. <<<|
